...
namespace AutoAirItem
{
    public class Database
    {
        ...
        public bool UpdateData(MyData.PlayerData data)
        {
            ...
            // 更新现有记录
            if (DB.Query("UPDATE AutoTrash SET Enabled = @0, Auto = @1, Mess = @2, ItemType = @3, DelItem = @4 WHERE Name = @5",
            ...
            // 如果没有更新到任何记录，则插入新记录
            return DB.Query("INSERT INTO AutoTrash (Name, Enabled, Auto, Mess, ItemType, DelItem) VALUES (@0, @1, @2, @3, @4, @5)",
        ...
        {
            return DB.Query("DELETE FROM AutoTrash") != 0;
        } 
        #endregion
    }
}